s$(document).ready(function() {
  $.getJSON("https://ipinfo.io/json", function(data) {
    ...
    $.getJSON("https://api.openweathermap.org/data/2.5/weather?zip=" + obj.postal + ",us" + "&APPID=6170f94b82996e99d1820c54af6208f1", function(weather) {
      ...
      document.getElementById("temperature").innerHTML = "<img width=120 src='https://openweathermap.org/img/w/" + obj2.weather[0].icon + ".png'></br>" + "Current Temperature: " + toFahr + "</br>" + "High for Today: " + toMax + "°F </br>" + "Low for Today: " + toMin + "°F"
      console.log(obj2)
